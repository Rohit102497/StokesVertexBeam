...
def model_fit_simulated(data_dir, batch_size, model_name, num_classes, feature_extract, use_pretrained, lr, momentum, num_epochs):
    ...
    return model_ft, hist, input_size
